    ...
    def OnData(self, data):
        ...
        for symbol, symbolData in self.Data.items(): #Return the dictionary's key-value pairs:
            ...
            if self.engulfing.IsReady:
                ...
                self.Log(f"{self.Time}, indicator_value: {indicator_value} , current price:{current_price}")
            ...
            if not self.Portfolio[symbol].Invested:
                ...
                if AboveResistance and self.engulfing.IsReady:
                ...
                if BelowSupport and self.engulfing.IsReady: 
...
Average Win 1.16%
Average Loss -5.18%
Compounding Annual Return 1.846%
Drawdown 13.300
Expectancy 0.019
Net Profit 1.840%
Loss Rate 17%
